 ...
 ******************************************************************************
 Database settings
 ******************************************************************************/
$SI_db['server']	= "shortstat-db.3amproductions.net";	// leave as localhost unless you know otherwise
$SI_db['username']	= "shortstat3am";	// The username used to acces your database
$SI_db['password']	= "shortstat";	// The password used to acces your database
$SI_db['database']	= "shortstatdatabase";	// The database where you would like to store the stats table
 ...
 ******************************************************************************/
$SI_display['sitename']		= "http://www.3amproductions.net";	// The full name of the site
